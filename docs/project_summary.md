# SentinelForge — Project Summary

This repository implements **SentinelForge**: a multimodal AI agent platform that routes user requests to specialized subsystems (RAG, risk scoring, recommendations, voice emotion, vision) and returns a unified response.

## 1) What the System Does

SentinelForge exposes a single “chat” surface (`/api/chat`) and a Streamlit UI that can:
