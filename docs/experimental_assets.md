...
This repository includes notebooks, prototypes, and one-off scripts that were used during exploration and iteration.
...
- Purpose: non-canonical training runs and research iterations.
