...
class SHAPDashboard:
    ...
    def _render_sidebar(self) -> None:
        ...
        if self.X_test is not None:
            ...
            st.session_state.sample_idx = st.sidebar.slider(
                "Sample Index",
                0, max_samples - 1, 0
            )
        ...
        st.session_state.max_features = st.sidebar.slider(
    ...
    def _render_feature_dependencies(self) -> None:
        ...
        shap.dependence_plot(
            feature_idx, shap_values, self.X_test,
            feature_names=feature_names,
            show=False
        )
        st.pyplot(fig)
    ...
    def _render_batch_analysis(self) -> None:
        ...
        with col2:
            end_idx = st.number_input("End Index", start_idx + 1, len(self.X_test), min(start_idx + 10, len(self.X_test)))
    ...
    def _export_report(self) -> None:
        ...
        report = {
            ...
            "global_importance": self.explainer.get_global_importance(self.X_test) if self.X_test is not None else {}
        }
