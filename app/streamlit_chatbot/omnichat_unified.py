"""
OmniChat Pratik - Unified ChatGPT-Style Interface
Complete all-in-one chatbot with:
- ChatGPT-like layout with bluish-gray background
        ...
        for idx, msg in enumerate(st.session_state.omni_messages):
            ...
            if role == "user":
                ...
                <div class="message-row assistant">
                    ...
                    <div class="message-content">
                        <strong style="color: #60a5fa;">🤖 OmniChat</strong>
                        <div style="margin-top: 6px;">{safe_content}</div>
                    </div>
                </div>
                """,
...
def main():
    """Standalone entry point for OmniChat Unified."""
    st.set_page_config(
        page_title="OmniChat Pratik - Unified AI Assistant",
        page_icon="🧠",
        layout="wide",
