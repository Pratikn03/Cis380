...
MOVIES_POOL = [
    # Action
    {"title": "The Dark Knight (2008)", "reason": "Christopher Nolan's masterpiece; genre: Action/Crime", "genre": "action"},
    {"title": "Mad Max: Fury Road (2015)", "reason": "Non-stop action spectacle; genre: Action/Sci-Fi", "genre": "action"},
    {"title": "John Wick (2014)", "reason": "Stylish action thriller; genre: Action/Thriller", "genre": "action"},
    {"title": "Die Hard (1988)", "reason": "Classic action film; genre: Action/Thriller", "genre": "action"},
    {"title": "Gladiator (2000)", "reason": "Epic historical action; genre: Action/Drama", "genre": "action"},
    {"title": "The Matrix (1999)", "reason": "Revolutionary sci-fi action; genre: Action/Sci-Fi", "genre": "action"},
    {"title": "Terminator 2 (1991)", "reason": "Iconic sequel; genre: Action/Sci-Fi", "genre": "action"},
    
    # Sci-Fi
    {"title": "Inception (2010)", "reason": "Mind-bending thriller; genre: Sci-Fi/Action", "genre": "sci-fi"},
    {"title": "Interstellar (2014)", "reason": "Epic space exploration; genre: Sci-Fi/Drama", "genre": "sci-fi"},
    {"title": "Blade Runner 2049 (2017)", "reason": "Stunning visual sci-fi; genre: Sci-Fi/Drama", "genre": "sci-fi"},
    {"title": "Arrival (2016)", "reason": "Intelligent alien contact story; genre: Sci-Fi/Drama", "genre": "sci-fi"},
    {"title": "Ex Machina (2014)", "reason": "Thought-provoking AI thriller; genre: Sci-Fi/Thriller", "genre": "sci-fi"},
    {"title": "The Martian (2015)", "reason": "Survival on Mars; genre: Sci-Fi/Adventure", "genre": "sci-fi"},
    
    # Comedy
    {"title": "The Grand Budapest Hotel (2014)", "reason": "Quirky Wes Anderson comedy; genre: Comedy/Drama", "genre": "comedy"},
    {"title": "Superbad (2007)", "reason": "Hilarious coming-of-age; genre: Comedy", "genre": "comedy"},
    {"title": "The Hangover (2009)", "reason": "Wild comedy adventure; genre: Comedy", "genre": "comedy"},
    {"title": "Bridesmaids (2011)", "reason": "Laugh-out-loud comedy; genre: Comedy", "genre": "comedy"},
    {"title": "Groundhog Day (1993)", "reason": "Classic Bill Murray comedy; genre: Comedy/Fantasy", "genre": "comedy"},
    {"title": "Dumb and Dumber (1994)", "reason": "Slapstick classic; genre: Comedy", "genre": "comedy"},
    
    # Drama
    {"title": "The Shawshank Redemption (1994)", "reason": "All-time classic; genre: Drama", "genre": "drama"},
    {"title": "Forrest Gump (1994)", "reason": "Heartwarming journey; genre: Drama/Romance", "genre": "drama"},
    {"title": "The Godfather (1972)", "reason": "Legendary crime drama; genre: Drama/Crime", "genre": "drama"},
    {"title": "Schindler's List (1993)", "reason": "Powerful historical drama; genre: Drama/History", "genre": "drama"},
    {"title": "Fight Club (1999)", "reason": "Cult classic thriller; genre: Drama/Thriller", "genre": "drama"},
    {"title": "Pulp Fiction (1994)", "reason": "Tarantino masterpiece; genre: Drama/Crime", "genre": "drama"},
    
    # Horror
    {"title": "Get Out (2017)", "reason": "Social horror thriller; genre: Horror/Thriller", "genre": "horror"},
    {"title": "A Quiet Place (2018)", "reason": "Tense survival horror; genre: Horror/Thriller", "genre": "horror"},
    {"title": "The Shining (1980)", "reason": "Kubrick horror classic; genre: Horror", "genre": "horror"},
    {"title": "Hereditary (2018)", "reason": "Disturbing family horror; genre: Horror/Drama", "genre": "horror"},
    {"title": "It (2017)", "reason": "Stephen King adaptation; genre: Horror", "genre": "horror"},
    
    # Animation
    {"title": "Spider-Man: Into the Spider-Verse (2018)", "reason": "Groundbreaking animation; genre: Animation/Action", "genre": "animation"},
    {"title": "Toy Story (1995)", "reason": "Pixar's first masterpiece; genre: Animation/Comedy", "genre": "animation"},
    {"title": "Finding Nemo (2003)", "reason": "Heartwarming adventure; genre: Animation/Family", "genre": "animation"},
    {"title": "The Incredibles (2004)", "reason": "Superhero family fun; genre: Animation/Action", "genre": "animation"},
    {"title": "Coco (2017)", "reason": "Beautiful Day of the Dead story; genre: Animation/Family", "genre": "animation"},
    
    # Thriller
    {"title": "Se7en (1995)", "reason": "Dark detective thriller; genre: Thriller/Crime", "genre": "thriller"},
    {"title": "Gone Girl (2014)", "reason": "Twisty psychological thriller; genre: Thriller/Drama", "genre": "thriller"},
    {"title": "Parasite (2019)", "reason": "Oscar-winning thriller; genre: Thriller/Drama", "genre": "thriller"},
    {"title": "Zodiac (2007)", "reason": "Gripping true crime; genre: Thriller/Crime", "genre": "thriller"},
    {"title": "Silence of the Lambs (1991)", "reason": "Classic psychological horror; genre: Thriller/Horror", "genre": "thriller"},
]
...
def movies_fallback(query: str) -> List[Dict]:
    ...
    genre_map = {
        ...
        "drama": "drama", "serious": "drama",
        "horror": "horror", "scary": "horror", "frightening": "horror",
...
NEWS_POOL = {
    "general": [
        {"title": "Breaking: Major Tech Company Announces Innovation", "reason": "Top story; Technology"},
    ...
    "health": [
        {"title": "New Treatment Shows Promise for Chronic Disease", "reason": "Medical breakthrough; Health"},
    ...
    "crime": [
        {"title": "Cybersecurity Alert: New Phishing Scam Detected", "reason": "Security; Technology"},
    ...
    "tech": [
        {"title": "AI Breakthrough: New Model Achieves Human-Level Performance", "reason": "AI; Technology"},
...
COURSES_POOL = [
    ...
    {"title": "Python for Data Science", "reason": "Learn pandas, numpy, sklearn; beginner-friendly"},
...
__all__ = ["movies_fallback", "places_fallback", "news_fallback", "cars_fallback", "courses_fallback"]
