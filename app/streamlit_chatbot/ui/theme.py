...
def apply_partik_theme(
    *, subtitle: str = "Cyber • Fraud • Behavior • Vision • Voice • Recsys"
    ...
    st.set_page_config(page_title="Sentifargo Command Center", page_icon="🧠", layout="wide")
    ...
    st.markdown(
        """
        <div class="watermark">Sentifargo</div>
        """,
        unsafe_allow_html=True,
    )
        ...
        <div class="glass-card" style="padding:18px 22px;margin-bottom:14px;">
            <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;">
                <div style="display:flex;align-items:center;gap:12px;">
                    ...
                    <div>
                        <div style="font-size:26px;font-weight:600;letter-spacing:0.04em;">Sentifargo</div>
    ...
    st.markdown(
        '<div class="footer-note">Built with local-first AI · Sentifargo</div>',
        unsafe_allow_html=True,
    )
