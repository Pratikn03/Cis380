...
def render_voice_chat_page(
    *,
    ...
    st.caption("Upload audio, transcribe via STT, and send the transcript to Sentifargo.")
    ...
    st.markdown(
        ...
        <div class="glass-card">
            <p class="muted">
                ...
                display the transcript, and let you ask Sentifargo without typing.
            </p>
        </div>
        """,
    ...
    if st.button("Ask Sentifargo (voice)", key="voice_chat_send"):
