...
class AlertSeverityScorer:
    ...
    def _apply_escalation(
        self, base_severity: Severity, risk_score: float, alert_type: str, context: Dict[str, Any]
    ...
    def _generate_description(
        self, alert_type: str, risk_score: float, severity: Severity, context: Dict[str, Any]
    ) -> str:
    ...
    def score_severity(
        self, alert_type: str, risk_score: float, context: Optional[Dict] = None
    ) -> Dict[str, Any]:
        """
        ...
        config = self.ALERT_CONFIGS.get(alert_type, {})
        applied_factors = [
            factor for factor in config.get("escalation_factors", {}).keys() if context.get(factor)
        ]
...
def create_alert(alert_type: str, risk_score: float, **kwargs) -> Optional[Alert]:
