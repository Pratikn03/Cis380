...
class CyberTimelineService:
        ...
        for i in range(num_events):
            ...
            event = TimelineEvent(
                ...
                metadata={
                    ...
                    "bytes_transferred": random.randint(100, 100000) if event_type in ["data_exfil", "scan"] else None,
                }
            )
    ...
    def get_sources_breakdown(self) -> Dict[str, Any]:
        ...
        source_stats = defaultdict(lambda: {"count": 0, "severities": defaultdict(int), "types": defaultdict(int)})
        ...
        for ip, stats in source_stats.items():
            ...
            sources.append({
                ...
                "risk_score": min(1.0, stats["count"] / 100 + stats["severities"].get("critical", 0) * 0.3),
            })
